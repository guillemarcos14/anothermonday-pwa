...
export const PRODUCTOS = {
  'Best Sellers': [
    ...
    { id: 3, nombre: 'Cookie Choco', precio: 6.50, categoria: 'Best Sellers', imagen: '/cookiechoco.webp', descripcion: 'Crujiente por fuera, fundida por dentro' },
    { id: 4, nombre: 'Muffin Choco', precio: 7.00, categoria: 'Best Sellers', imagen: '/muffinchoco.webp', descripcion: 'Esponjoso con trozos de chocolate negro' },
  ],
  'Café': [
  ...
  'Matcha': [
    ...
    { id: 22, nombre: 'Chai Latte', precio: 5.20, categoria: 'Matcha', imagen: '/chailatte.webp', descripcion: 'Especias cálidas con leche sedosa' },
    { id: 23, nombre: 'Iced Chai Latte', precio: 4.80, categoria: 'Matcha', imagen: '/icedchailatte.webp', descripcion: 'Chai especiado sobre hielo, dulce y fresco' },
  ],
  'Comida': [
    { id: 30, nombre: 'Cookie Choco', precio: 6.50, categoria: 'Comida', imagen: '/cookiechoco.webp', descripcion: 'Crujiente por fuera, fundida por dentro' },
    { id: 31, nombre: 'Muffin Choco', precio: 7.00, categoria: 'Comida', imagen: '/muffinchoco.webp', descripcion: 'Esponjoso con trozos de chocolate negro' },
    { id: 32, nombre: 'Croissant', precio: 3.00, categoria: 'Comida', imagen: '/croissant.webp', descripcion: 'Mantequilla francesa, capas hojaldradas' },
    { id: 33, nombre: 'Roll Canela', precio: 3.50, categoria: 'Comida', imagen: '/rollcanela.webp', descripcion: 'Masa tierna con canela y glaseado suave' },
  ],
}
